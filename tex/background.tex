...
Understandability and readability can improve the characteristics used by the standard to measure code quality. If code is harder to understand for developer, it is more likely that any code change will impact reliability, performance efficiency, security or maintainability, since the developer may not understand all implications of the change. 
