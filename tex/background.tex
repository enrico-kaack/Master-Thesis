...
The term code quality defines an evaluation of source code concerning the readability and understandability of the source code. If it is well-written and can be understood by developers easily, it is considered to be high quality. TODO rewrite to reliability, robustness, maintainability, readability siehe Softwarequalität wikipedia seite, gibt besseren eindruck
