...
\begin{lstlisting}[float=t , language=Python, label=lst:hungarian_notation, caption={Example for the Hungarian notation in an adaption to use the prefix to indicate the type.}]
def fnFunctionName():
    dbValue = 0.1 #double
    iSize = 5 #integer
