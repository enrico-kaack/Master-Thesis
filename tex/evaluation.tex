...
Type encoding increases the performance of the random forest classifier slightly for the CCS and CC type. We observe a slight increase of up to 0.02. For the RN problem type, we observe a similar improvement with oversampling. For undersampling, we observe a significant decrease of \~0.09 in f1 performance. 
