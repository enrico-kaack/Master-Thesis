...
TODO depend on results of no under/over results
- cant handle hard class inbalance but seems to be ok with CCS and CS (get how many samples per class)
--> there is a certain threshold for class inbalance random forest can handle, otherwise its performance deteriotes
