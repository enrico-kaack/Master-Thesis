...
\begin{table}[]
    \begin{tabular}{|l|l|l|l|}
        \hline
                             & RETURN NONE & CONDITION SIMPLE & CONDITION COMPARISON \\ \hline
    0       & 99.79\%      & 97.32\%                       & 95.11\%               \\ \hline
    1 & 0.21\%       & 2.68\%                        & 4.89\%            \\ \hline
    \end{tabular}
    \caption{Class distribution for the dataset. Label [0] represents clean code and label [1] makrs problematic code of the corresponding category.}
