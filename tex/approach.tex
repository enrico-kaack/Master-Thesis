...
,  columns=fullflexible, label=lst:stdout]
...
\chapter{Clean Code Classification}
...
\begin{enumerate}
    \item There is no annotation in neither issues descriptions nor git commit messages that would reliably tell, if the change is changing a violation of the clean code rules. (TODO screenshot of two differnt commit messages with clean code improvement?)
...
The average lines of code per file is similiar with a small difference of 5.5\%. For all problem types, the difference in lines of code containing the problem is smaller than 0.05 percentage point. This metric is important, since this results in compareable label distribution TODO.
...
\begin{table}[]
    ...
    \multirow{4}{*}{}                            & Metric                  & Train/Test & Holdout \\ \cmidrule(l){2-4} 
                                                 & Lines of Code           & 2,789,853  & 658,966 \\
                                                 & Number of Files         & 14,811     & 3,702   \\
                                                 & average LOC per File    & 188.36     & 178     \\ \midrule
    \multirow{2}{*}{Return None}                 & LOCs containing problem & 0.08\%     & 0.08\%  \\
                                                 & Problems per File       & 0.14       & 0.14    \\ \midrule
    \multirow{2}{*}{Condition Comparison Simple} & LOCs containing problem & 1.3\%      & 1.25\%  \\
                                                 & Problems per File       & 2.44       & 2.22    \\ \midrule
    \multirow{2}{*}{Condition Comparison}        & LOCs containing problem & 2.36\%     & 2.36\%  \\
                                                 & Problems per File       & 4.44       & 4.19    \\ \bottomrule
    \end{tabular}
...
The analysis for the CONDITION COMPARISON problem type is an advancement of the analysis of the CONDITION COMPARISON SIMPLE problem type.  See listing TODO for examples of the different analysis results.
