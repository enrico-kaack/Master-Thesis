...
\begin{table}[]
    ...
    \end{tabularx}
    \caption{Class frequencies for all problem types on the train, validation and holdout set. We observe a compareable class distribution amoung the datasets for each problem type.}
...
\begin{figure}
    ...
    \caption{Split of the dataset. First, 20\% of all files are seperated into a holdout set for later testing. The remainding 80\% of the files are split into 90\% training and 10\% validation data. }
