...
We ensured to have a similiar data and label distribution on all data sets. Table \ref{tab:general_data_distribution} shows general and problem specific metrics for the train, test and holdout set. The problem specific metrics are collected after processing the code files as described in chapter \ref{sec:data_encoding}. The label distribution on all three datasets is noted in table TODO.
