...
%appendix chapter size  
\usepackage{titlesec} %TODO not working on linux
\AtAppendix{%
\titleformat{\chapter}[display]{\vspace*{-70pt}\normalfont\bfseries\large}{\chaptertitlename~\thechapter}{1em}{}
\titlespacing*{\chapter}{0pt}{0pt}{0pt}}%

\usepackage{float}

\newcommand{\high}[1]{\textit{#1}}
